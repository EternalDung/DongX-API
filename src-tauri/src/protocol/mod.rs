...
//! are translated to/from that internal shape here (the four core conversions are
//! `anthropic_to_openai, openai_to_anthropic, responses_to_openai, openai_to_responses`).
//!
//! Both the non-streaming request/response translation and the streaming
//! reverse-conversion live in this module (the protocol owns conversion for both
//! sync and streaming):
